...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class StartResourceOperationResult
    {
        ...
        internal StartResourceOperationResult(string description, string resourceType, string location)
        {
        ...
        internal StartResourceOperationResult(string description, string resourceType, string location, IReadOnlyList<ResourceOperationResult> results, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Description = description;
            ResourceType = resourceType;
            Location = location;
