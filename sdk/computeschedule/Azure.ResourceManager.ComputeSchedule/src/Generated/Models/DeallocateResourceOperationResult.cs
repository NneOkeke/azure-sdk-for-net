...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class DeallocateResourceOperationResult
    {
        ...
        internal DeallocateResourceOperationResult(string description, string resourceType, string location)
        {
        ...
        internal DeallocateResourceOperationResult(string description, string resourceType, string location, IReadOnlyList<ResourceOperationResult> results, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Description = description;
            ResourceType = resourceType;
            Location = location;
