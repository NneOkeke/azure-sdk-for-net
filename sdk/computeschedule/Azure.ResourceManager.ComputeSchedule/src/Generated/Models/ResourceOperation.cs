...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ResourceOperation
    {
        ...
        internal ResourceOperation(string resourceId, string errorCode, string errorDetails, ResourceOperationDetails operation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
