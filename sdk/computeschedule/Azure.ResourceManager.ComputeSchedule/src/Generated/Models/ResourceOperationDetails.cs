...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class ResourceOperationDetails
    {
        ...
        internal ResourceOperationDetails(string operationId, string resourceId, ResourceOperationType opType, string subscriptionId, DateTimeOffset deadline, DeadlineType deadlineType, OperationState state)
        {
