...
{
    /// <summary> Representation of the possible selection of days in a week in a gregorian calendar for auto actions. </summary>
    public readonly partial struct WeekDay : IEquatable<WeekDay>
    {
        ...
        public static bool operator !=(WeekDay left, WeekDay right) => !left.Equals(right);
        /// <summary> Converts a <see cref="string"/> to a <see cref="WeekDay"/>. </summary>
