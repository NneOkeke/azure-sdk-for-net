...
namespace Azure.ResourceManager.ComputeSchedule.Models
{
    ...
    public partial class OccurrenceProperties
    {
        ...
        internal OccurrenceProperties(DateTimeOffset initialScheduledOn, OccurrenceResultSummary resultSummary)
        {
            InitialScheduledOn = initialScheduledOn;
        ...
        internal OccurrenceProperties(DateTimeOffset initialScheduledOn, OccurrenceResultSummary resultSummary, OccurrenceState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            InitialScheduledOn = initialScheduledOn;
            ResultSummary = resultSummary;
        ...
        /// <summary> The time the occurrence was initial scheduled for. Actual scheduled time for resources can change by calling the delay API. </summary>
        public DateTimeOffset InitialScheduledOn { get; }
