...
#pragma warning disable SA1649 // File name should match first type name
    internal class ComputeScheduleArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ComputeScheduleArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeScheduleArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "ComputeScheduleArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
