...
namespace Azure.ResourceManager.ComputeSchedule.Mocking
{
    ...
    public partial class MockableComputeScheduleResourceGroupResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of AutoActionResources in the ResourceGroupResource. </summary>
        /// <returns> An object representing collection of AutoActionResources and their operations over a AutoActionResource. </returns>
        public virtual AutoActionCollection GetAutoActions()
        {
            return GetCachedClient(client => new AutoActionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AutoActionResource>> GetAutoActionAsync(string autoActionName, CancellationToken cancellationToken = default)
        {
            return await GetAutoActions().GetAsync(autoActionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="autoActionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AutoActionResource> GetAutoAction(string autoActionName, CancellationToken cancellationToken = default)
        {
            return GetAutoActions().Get(autoActionName, cancellationToken);
        }
    }
}
